...
class ViewController: UIViewController {
  ...
  @IBAction func buttonTapped(_ sender: UIButton) {
    ...
    if sender.tag == correctAnswer {
      ...
      title = "Wrong, thats \(countries[sender.tag])"
      score -= 1
      questionsAnswered += 1
    }
  ...
  @objc func scorePopUp() {
    let ac = UIAlertController(title: "Keep it up!", message: "Your score is \(score)", preferredStyle: .alert)
