...
//  HWS Project 11
//
//  Created by Christopher Koski on 9/23/21.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
  ...
  var ballArray = ["ballBlue", "ballCyan", "ballGreen", "ballRed", "ballGrey", "ballPurple", "ballYellow" ]
  ...
  override func didMove(to view: SKView) {
    ...
    ballLimitLabel.position = CGPoint(x: 980, y: 665)
