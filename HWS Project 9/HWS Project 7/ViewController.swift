...
class ViewController: UITableViewController {
  ...
  @objc func showError() {
    let ac = UIAlertController(title: "Loading error", message: "There was a problem laoding the feed, please check your connection and try again", preferredStyle: .alert)
